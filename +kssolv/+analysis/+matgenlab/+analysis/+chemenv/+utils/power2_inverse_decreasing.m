function value=power2_inverse_decreasing(input,varargin)
%POWER2_INVERSE_DECREASING Reciprocal quadratic decrease.
...
value=prefactor*(input-1).^2./input;value(abs(input)<1e-12)=inf;
end
