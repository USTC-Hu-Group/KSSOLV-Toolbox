function value=power2_tangent_decreasing(input,varargin)
%POWER2_TANGENT_DECREASING Infinite-to-zero tangent decrease.
...
value=-prefactor*(input-1).^2.*tan((input-1)*pi/2);
end
