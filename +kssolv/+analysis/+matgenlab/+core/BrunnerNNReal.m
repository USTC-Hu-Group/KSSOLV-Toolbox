classdef BrunnerNNReal < kssolv.analysis.matgenlab.core.NearNeighbors
    %#ok<*ALIGN>
    properties
        tol (1,1) double=1e-4
        cutoff (1,1) double=8
    ...
    methods
        function obj=BrunnerNNReal(varargin)
        ...
        function info=get_nn_info(obj,structure,n)
            ...
            [~,which]=max(diff(distances));limit=distances(which);info={};
