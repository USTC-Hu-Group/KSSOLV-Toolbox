classdef BrunnerNNRelative < kssolv.analysis.matgenlab.core.NearNeighbors
    %#ok<*ALIGN>
    properties
        tol (1,1) double=1e-4
        cutoff (1,1) double=8
    ...
    methods
        function obj=BrunnerNNRelative(varargin)
        ...
        function info=get_nn_info(obj,structure,n)
            ...
            [~,which]=max(distances(2:end)./distances(1:end-1));
            limit=distances(which);info={};
