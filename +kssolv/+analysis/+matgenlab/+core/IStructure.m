    ...
    methods
        ...
        function neighbors = get_sites_in_sphere(obj, point, radius, options)
            ...
            for siteIndex = 1:obj.num_sites
                ...
                for a = -imageRange(1):imageRange(1)
                    for b = -imageRange(2):imageRange(2)
                        for c = -imageRange(3):imageRange(3)
                            image = [a, b, c];
                            delta = site.frac_coords + image - fractionalPoint;
                            distance = norm( ...
                                obj.lattice.get_cartesian_coords(delta));
                            if distance <= radius + 1e-12
                                ...
                                neighbor = ...
                                    kssolv.analysis.matgenlab.core.PeriodicNeighbor( ...
                                        site.species, ...
                                        site.frac_coords + image, obj.lattice, ...
                                        distance, neighborIndex, neighborImage, ...
