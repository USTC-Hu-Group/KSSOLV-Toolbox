classdef Diagonalization < kssolv.analysis.matgenlab.io.cp2k.Section
 methods
  function obj=Diagonalization(varargin)
   obj@kssolv.analysis.matgenlab.io.cp2k.Section("DIAGONALIZATION");
