classdef EDensityCube < kssolv.analysis.matgenlab.io.cp2k.Section
 methods
  function obj=EDensityCube(varargin)
   obj@kssolv.analysis.matgenlab.io.cp2k.Section("E_DENSITY_CUBE");
