classdef OrbitalTransformation < kssolv.analysis.matgenlab.io.cp2k.Section
 methods
  function obj=OrbitalTransformation(varargin)
   obj@kssolv.analysis.matgenlab.io.cp2k.Section("OT");
