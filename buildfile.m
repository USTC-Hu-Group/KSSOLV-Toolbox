...
requiredToolboxFiles = [ ...
    ...
    fullfile(toolboxFolder, "docs", "usage", "start.zh-CN.md")
    fullfile(toolboxFolder, "docs", "configuration.md")
    fullfile(toolboxFolder, "docs", "configuration.zh-CN.md")
    fullfile(toolboxFolder, "docs", "modeling-user-guide.md")
    fullfile(toolboxFolder, "docs", "modeling-user-guide.zh-CN.md")
    fullfile(toolboxFolder, "docs", "modeling-api.md")
    fullfile(toolboxFolder, "docs", "structure-io-api.md")
    fullfile(toolboxFolder, "docs", "volume-viewer-user-guide.md")
    fullfile(toolboxFolder, "docs", "volume-viewer-user-guide.zh-CN.md")
    fullfile(toolboxFolder, "docs", "remote-computing-user-guide.md")
    fullfile(toolboxFolder, "docs", "remote-computing-user-guide.zh-CN.md")
